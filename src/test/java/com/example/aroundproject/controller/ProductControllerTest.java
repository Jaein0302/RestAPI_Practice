package com.example.aroundproject.controller;
...
import com.example.aroundproject.service.impl.ProductServiceImpl;
...
public class ProductControllerTest {
    ...
    // 주입 받고 있는 객체에 대해 가짜 객체를 생성해주는 어노테이션 (실제 행위는 하지 않는다)
    @MockBean
    ...
    void createProductTest() throws Exception {
        ...
        //productDTO -> json으로 바꿀 수 있는 첫번째 방법
        Gson gson = new Gson();
        String content = gson.toJson(productDto);

        // 2번쨰 방법. 아래 코드로 json 형태 변경 작업을 대체할 수 있음
